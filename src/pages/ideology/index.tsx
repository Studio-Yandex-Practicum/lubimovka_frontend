      ...
      <div className={cn(style.container, style.containerSecond)}>
        ...
        <div className={style.list}>
          ...
          <TextItem number='2.1' title='Открывать театральному миру новых авторов. '>
            <p className={cn(style.paragraph, style.paragraphText)}>Чтобы наш фестиваль служил местом встречи начинающих авторов и признанных драматургов, зрителей и театральных профессионалов, представителей разных поколений и художественных течений.</p>
          </TextItem>

          <TextItem number='2.2' title='Дать начинающим авторам возможность найти свой голос и быть услышанными'>
            <p className={cn(style.paragraph, style.paragraphText)}>Чтобы уже в начале своего творческого пути драматурги получали опыт взаимодействия с аудиторией и театральными профессионалами и совершенствовали своё мастерство. Вдохновлять молодых авторов на написание новых пьес.</p>
          </TextItem>

          <TextItem number='2.3' title='Обогатить отечественный театр качественными новыми актуальными пьесами'>
            <p className={cn(style.paragraph, style.paragraphText)}>Чтобы наш фестиваль был оживленным перекрестком мнений и взглядов, в центре которого — новые пьесы, говорящие о сегодняшних реалиях и ценностях, которые составляют основу жизни современного человека и общества.</p>
          </TextItem>
        </div>
      </div>
    </section>
