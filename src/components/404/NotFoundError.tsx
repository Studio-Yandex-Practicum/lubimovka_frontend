    ...
    <section className={classes.error}>
      ...
      <div className={classes.contentContainer}>
        ...
        <ul className={classes.list}>
          ...
          <li className={classes.listItem}><Link href={'/form'}><a className={classes.link}>&rarr; Подать пьесу</a></Link></li>
          <li className={classes.listItem}><Link href={'/donation'}><a className={classes.link}>&rarr; Поддержать</a></Link></li>
        </ul>
      </div>
