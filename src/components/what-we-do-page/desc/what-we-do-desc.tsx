  ...
  <section className={cx('descItem')}>
    ...
    <aside className={cx('container', 'containerInvite')}>
      ...
      <p className={cx('desc')}>
        ...
        Мы уважаем личный выбор художественных целей и творческих методов. Мы ценим готовность автора обсуждать свою работу и доверяем ему в его дальнейшей работе.
      </p>
      <p className={cx('desc')}>
